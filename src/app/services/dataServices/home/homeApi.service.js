...
//        var preUrl = '/msc/mt/settle_config/travel/:action';
       // var baseUrl = '/msc/mt/:tra/:path';
        ...
        //     },
        //     getArticleByKind: {
        //         url: 'http://www.dlnubbs.com/web/Artile/artileList?page=' + ,
        //         method: 'POST'
        //     },
        //     like: {
        ...
        // });
        return {
            'login': $resource('http://www.dlnubbs.com/web/Auth/login', {}, {method: 'post', ignoreLoadingBar: true}),    
            'register': $resource('http://www.dlnubbs.com/web/Auth/register', {}, {method: 'post'}),
            'user': $resource('http://www.dlnubbs.com/web/Auth/getUserInfo', {}, {method: 'post'}),
            'getArticleKinds': $resource('http://www.dlnubbs.com/web/ArtileKind/getKind', {}, {method: 'post'}),
            'getHotArticles': $resource('http://www.dlnubbs.com/web/index/getHotArtile', {}, {method: 'post'}),
